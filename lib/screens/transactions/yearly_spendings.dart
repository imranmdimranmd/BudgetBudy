...
class _YearlySpendingsState extends State<YearlySpendings> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<PieData> yearlyData =
        PieData.pieChartData(yearlyTrans, byCategory: _byCategory);
    ...
    return Column(
      children: [
        Card(
          ...
          child: MyPieChart(
            pieData: yearlyData,
            sourceTransactions: yearlyTrans,
